<img src="images/Readme-banner.png" height="auto">.
## Angular Node Express Mongodb ecommerce website!
### Content
...
npm install
```
- due to the use of monorepo, the shop and admin app are divided, you can run each of them with the following commands:

```sh
nx serve skshop --port=4100
```
```sh
nx serve admin --port=4200
```
- Make sure to use those exact ports please !
<img src="images/port4100.png" height="auto">
<img src="images/port4200.png" height="auto">

- Don't hesitate to fork the project and add more functionalities and send a pull request on the project
...
The project is an ecommerce platform, with all functionalities but payment, you can see it as a Cash on Delivery Platform.

- Skshop :
  <img src="images/skshopindex.png" height="auto">
- Admin :
  <img src="images/Screenshotadmin.png" height="auto">
